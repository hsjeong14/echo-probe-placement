...
OUT_PATH = "<REPO_ROOT>/figures/qualitative_v4_best6.png"
...
VIEWS = ["PLAX", "A4C"]
CASE_IDS = ["s1111", "s0836", "s0553", "s1046", "s0733", "s0794"]  # TRUE best 6 by v4's own combined PLAX+A4C tangential error
...
fig.suptitle("v4 qualitative results - TRUE best 6 by v4's own tangential error (seed 0)",
              fontsize=11, y=0.985)
fig.savefig(OUT_PATH, dpi=200, facecolor="white")
print(f"saved {OUT_PATH}")

with open("<REPO_ROOT>/results/qualitative_v4_best6_tangential_err.json", "w") as f:
